...
## Presenting my research at The Council of the Hong Kong Laureate Forum 2025

Giving an oral presentation in a forum with Shaw Laureates and Nobel Prizes was real honor. The science, discussions and people were absolutely top! Find more information about the forum in their [website](https://www.hklaureateforum.org/en/)

```{r layout = "m-page", echo=FALSE}
knitr::include_graphics("HKLF.jpg")
```
...
Granted the honorary RGC Postdoctoral fellowship  [UGC](https://www.ugc.edu.hk/eng/rgc/funding_opport/jrfs/) to work at the [Ocean Ecol Lab](https://www.oceanecol.com/) from [HKUST](https://hkust.edu.hk/). Our fieldwork plans to occur in the Coral Triangle, mainly in Indonesia, using technical diving to access mesophotic depths.

```{r layout = "m-page", echo=FALSE}
knitr::include_graphics("RGC_Fellowship.jpg")
```
...
knitr::include_graphics("HKUST_Background.JPG")
```
...
```{r layout = "l-page", echo=FALSE}
knitr::include_graphics("Moorea_Living.JPG")
```
...
```{r layout = "m-page", echo=FALSE}
knitr::include_graphics("PhD_Defense.JPG")
```
...
Moving to the Canary Islands for my studies was simply the best choice. I quickly became even more in love with the ocean while learning more and more about it. Thanks, [Universidad de Las Palmas de Gran Canaria](http://ulpgc.es/) y [Facultad de Ciencias del Mar](https://mar.ulpgc.es/) – it was an absolute pleasure. 
My studies and my leisure time were all in or about the ocean. Studying and working hard and enjoying ocean related activities such as diving, snorkelling and surfing. 


```{r layout = "l-page", echo=FALSE}
knitr::include_graphics("1a_Grado_CCM.jpg")
```
We were the first generation in the Grado de Ciencias del Mar. 

During my undergraduate studies, my subject interests switched from pure marine biology to physical oceanography to marine conservation and communication to fisheries management. I wanted an ocean-related professional career, ideally in science, but I needed to find my way and opportunities. Following the recommendations from my best teaching mentors, I had to look for the best opportunities abroad. So I did, and who knows if one day I will be able to come back? Hopefully yes!
